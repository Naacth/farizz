...
<section class="relative bg-gradient-to-r from-sky-600 via-blue-600 to-sky-700 text-white py-40 overflow-hidden">
    ...
    <div class="container mx-auto px-4 text-center relative z-10 fade-in-up">
        <div class="mb-6">
            <span class="inline-block bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full text-sky-100 font-medium mb-6">
        ...
        <p class="text-2xl text-sky-100 max-w-3xl mx-auto mb-12 leading-relaxed">
        ...
        <div class="mt-12 flex justify-center gap-6 flex-wrap">
            <a href="/activity" class="group bg-white text-sky-700 px-10 py-5 rounded-2xl font-bold hover:bg-sky-50 transition-all duration-300 inline-flex items-center shadow-2xl hover:shadow-sky-300/50 transform hover:scale-110 hover:-translate-y-2">
                <i class="fas fa-calendar-check mr-3 text-3xl group-hover:rotate-12 transition-transform"></i>
                <div class="text-left">
                    <div class="text-sm text-sky-600">Explore</div>
...
<section class="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
    <!-- Decorative Elements -->
    <div class="absolute top-0 right-0 w-64 h-64 bg-sky-100 rounded-full blur-3xl opacity-50"></div>
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-purple-100 rounded-full blur-3xl opacity-50"></div>

    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-20 fade-in-up">
            <span class="inline-block bg-sky-100 text-sky-700 px-4 py-2 rounded-full text-sm font-bold mb-4">
                PORTFOLIO SECTIONS
            </span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto">
            ...
            <div class="group relative">
                ...
                <a href="/activity" class="relative block bg-white p-10 rounded-3xl shadow-2xl hover-lift border border-gray-100 overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-sky-100 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-black text-gray-800 mb-4 group-hover:text-sky-600 transition-colors">Daily Activities</h3>
                        <p class="text-gray-600 mb-6 leading-relaxed">Track and showcase my daily professional activities with stunning photos and videos</p>
                        <div class="flex items-center text-sky-600 font-bold group-hover:gap-4 gap-2 transition-all">
            ...
            <div class="group relative">
                ...
                <a href="/profile" class="relative block bg-white p-10 rounded-3xl shadow-2xl hover-lift border border-gray-100 overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-black text-gray-800 mb-4 group-hover:text-purple-600 transition-colors">Professional Profile</h3>
                        <p class="text-gray-600 mb-6 leading-relaxed">View my complete CV including contact information and career summary</p>
                        <div class="flex items-center text-purple-600 font-bold group-hover:gap-4 gap-2 transition-all">
            ...
            <div class="group relative">
                ...
                <a href="/education" class="relative block bg-white p-10 rounded-3xl shadow-2xl hover-lift border border-gray-100 overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-black text-gray-800 mb-4 group-hover:text-emerald-600 transition-colors">Education History</h3>
                        <p class="text-gray-600 mb-6 leading-relaxed">Discover my educational journey from elementary school to university</p>
                        <div class="flex items-center text-emerald-600 font-bold group-hover:gap-4 gap-2 transition-all">
